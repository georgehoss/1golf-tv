...
List<LeagueDetails> leagueDetailsFromJson(String str) => List<LeagueDetails>.from(
      json.decode(str).map((x) => LeagueDetails.fromJson(x)),
    );
...
class LeagueDetails {
  ...
  String? type;
  String? logo;
  LeagueComponents? components;

  LeagueDetails({this.id, this.title, this.type, this.logo, this.components});
  ...
  factory LeagueDetails.fromJson(Map<String, dynamic> json) => LeagueDetails(
        ...
        components: json['components'] == null
            ? null
            : LeagueComponents.fromJson(json['components']),
      );
...
class LeagueComponents {
  ...
  factory LeagueComponents.fromJson(Map<String, dynamic> json) =>
      LeagueComponents(
        items: json['items'] == null
            ? []
            : List<LeagueItem>.from(
                json['items']!.map((x) => LeagueItem.fromJson(x)),
              ),
